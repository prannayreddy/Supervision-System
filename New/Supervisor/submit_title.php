...
if($row['title_status']==1)
{
echo "<a href='update_project_status.php?id=".$row['Tid']."&status=1'><span  style='color:red'>Not Approved</span></a>";
}
else
{
echo "<a href='update_project_status.php?id=".$row['Tid']."&status=0'><span  style='color:green'>Approved</span></a>";
}
?>
</Td>
<?php 
