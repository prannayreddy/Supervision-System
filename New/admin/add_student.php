 ...
 if(isset($signup))
 {
	 ...
	 $que=mysqli_query($con,"select email from student where email='$e'");
	 ...
	 {
	 $pass=md5($pass);
	 mysqli_query($con,"insert into student values('','$n','$e','$pass','$mob','$gen','$prog','$course')");
	$err="<font color='green'>New Student added !!!  </font>";
	 }
