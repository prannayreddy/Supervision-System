        ...
        <div class="mainmenu-wrapper">
	        <div class="container">
		        ...
		        <nav id="mainmenu" class="mainmenu">
					<ul>
						<li class="logo-wrapper"><a href="index.php"><span style="color:#000000;font-weight:bold;font-size:25px">SSS</span></a></li>
						<li class="active"><a href="index.php">Home</a></li>
						<li><a href="about.php">About</a></li>
						<li><a href="Student.php">Student</a></li>
						<li><a href="Supervisior.php">Supervisior</a></li>
